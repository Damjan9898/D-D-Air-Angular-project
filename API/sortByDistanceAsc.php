...
$rezultat = mysqli_query($db, "select * from flight WHERE flight.airline = '$airline' AND flight.locationstart = '$locationstart' AND flight.locationend = '$locationend' AND flight.classflight = '$classflight' AND flight.flightstart = '$flightstart' order by distance ASC;");
