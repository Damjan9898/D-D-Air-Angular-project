...
@Component({
  selector: 'app-best-offer-flights',
  templateUrl: './best-offer-flights.component.html',
  styleUrls: ['./best-offer-flights.component.css']
})
export class BestOfferFlightsComponent {
  flights;
  ...
  const path = "http://localhost/API/getFlightsOffer.php";
